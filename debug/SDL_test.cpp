...
int main ( int argc, char *argv[] )
{
    ...
    #else
        TTF_Font *DayFont = TTF_OpenFont("/home/snakeleon/.fonts/DIGITAL-Regular.ttf", 60);
        if (!DayFont)
        {
    ...
    #else
        TTF_Font *NumFont = TTF_OpenFont("/home/snakeleon/.fonts/DIGITAL-Regular.ttf", 30);
        if (!NumFont)
        {
            std::cout << "ERROR for Open TTF_Font" << std::endl;
            return 22;
    ...
    #else
        TTF_Font *LogoFont = TTF_OpenFont("/home/snakeleon/.fonts/Hack-RegularOblique.ttf", 30);
        if (!LogoFont)
        {
            std::cout << "ERROR for Open TTF_Font" << std::endl;
            return 23;
